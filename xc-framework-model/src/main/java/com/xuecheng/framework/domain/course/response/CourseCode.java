...
public enum CourseCode implements ResultCode {
    ...
    COURSE_NOT_FOUND(false, 31103, "课程不存在!"),
    COURSE_PIC_NOT_FOUND(false, 31104, "课程图片不存在"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false, 31105, "课程计划不存在！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false, 31106, "只允许选择第三级的课程计划！");
    //操作代码
